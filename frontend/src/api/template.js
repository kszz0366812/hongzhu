...
// 分页获取接口模板列表
export function getTemplateListPage(page,size,data) {
  return request({
    url: `/itfTemplate/page/${page}/${size}`,
    method: 'post',
    data
  });
}
...
//分页调用自定义接口 
export function getCustomInterfacePage(id,page,size,data) {
  return request({
    url: `/customize/getInterfaceInfoPage/${id}/${page}/${size}`,
    method: 'post',
    data
  });
}
