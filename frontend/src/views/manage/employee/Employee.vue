<template>
  <el-card>
    ...
    <el-table :data="list" border stripe style="width: 100%" v-loading="loading">
      ...
      <el-table-column prop="directLeader" label="直属领导" width="120" />
      ...
      <el-table-column prop="regionLevel1" label="大区" />
      <el-table-column prop="regionLevel2" label="地市" />
      <el-table-column prop="regionLevel3" label="区域" width="200" />
      <el-table-column prop="position" label="岗位" />
      <el-table-column prop="levels" label="职级" />
      <el-table-column prop="channel" label="渠道" />
      <el-table-column prop="joinDate" label="入司日期" width="120">
        <template #default="scope">
        ...
        <el-row :gutter="24">
          <el-col :span="8">
            <el-form-item label="直属领导" prop="directLeaderId">
              <EmployeeSelector
                v-model="dialog.form.directLeaderId"
                placeholder="请选择直属领导"
...
function handleDirectLeaderChange(data) {
  if (data && data.employee) {
    dialog.form.directLeader = data.employee.name
  } else {
