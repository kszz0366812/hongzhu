<template>
  <el-card>
    ...
    <el-table :data="list" border stripe style="width: 100%">
      ...
      <el-table-column prop="achievedAmount" label="已达成金额" width="120">
        <template #default="scope">
    ...
    <el-dialog v-model="dialog.visible" :title="dialog.form.id ? '编辑任务' : '新增任务'" width="600px">
      <el-form :model="dialog.form" :rules="rules" ref="formRef" label-width="100px">
        <el-form-item label="执行人" prop="executorId">
          <EmployeeSelector 
            v-model="dialog.form.executorId"
            placeholder="请选择执行人"
...
// 处理员工选择变化
function handleEmployeeChange(data) {
  if (data && data.employee) {
    dialog.value.form.executor = data.employee.name
  }
}
