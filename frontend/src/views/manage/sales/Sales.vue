<template>
  <el-card>
    ...
    <el-table :data="list" border stripe style="width: 100%">
      <el-table-column prop="sales_order_no" label="销售单号" width="120" />
      <el-table-column prop="sales_date" label="销售日期" width="160" />
      <el-table-column prop="customer_name" label="客户名称" />
      <el-table-column prop="customer_level" label="客户等级" />
      <el-table-column prop="distributor" label="配送商" />
