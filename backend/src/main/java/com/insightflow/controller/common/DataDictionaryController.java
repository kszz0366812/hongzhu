...
public class DataDictionaryController {
    ...
    @GetMapping("/list")
    public Result<PageInfo<DictionaryVO>> list(
        ...
        PageInfo<DictionaryVO> result = dataDictionaryService.getPage(pageNum, pageSize, name, code, type, parentId, parentName);
