...
public interface ProjectService extends IService<Project> {
     ...
     * 分页查询项目列表
     */
    IPage<Project> getProjectList(Integer page, Integer size, String status, String keyword);

    /**
     * 分页查询项目列表（包含成员信息）
     */
    IPage<ProjectListDTO> getProjectListWithMembers(Integer page, Integer size, String status, String keyword);
