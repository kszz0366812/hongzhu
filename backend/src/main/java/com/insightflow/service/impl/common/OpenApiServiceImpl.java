                    ...
                    if (syncDTO != null && syncDTO.getData() != null) {
                        ...
                        for (DealSyncDTO.DealData data : syncDTO.getData()) {
                            try {
                                ...
                                dealRecord.setDealTime(LocalDateTime.parse(data.getDealTime(), DateTimeFormatter.ISO_DATE_TIME));
                                dealRecord.setVisitId(data.getVisitId());
                                dealRecord.setDealEmployeeId(data.getDealEmployeeId());
                                dealRecord.setProductId(data.getProductId());
                                dealRecord.setQuantity(data.getQuantity());
                                dealRecord.setUnit(data.getUnit());
                                dealRecord.setUnitPrice(data.getUnitPrice());
                                dealRecord.setTotalPrice(data.getTotalPrice());
