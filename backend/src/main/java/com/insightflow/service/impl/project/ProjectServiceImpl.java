...
public class ProjectServiceImpl extends ServiceImpl<ProjectMapper, Project> implements ProjectService {
    ...
    @Override
    public IPage<Project> getProjectList(Integer page, Integer size, String status, String keyword) {
    ...
    @Override
    public IPage<ProjectListDTO> getProjectListWithMembers(Integer page, Integer size, String status, String keyword) {
        // 首先获取项目列表
        IPage<Project> projectPage = getProjectList(page, size, status, keyword);
        
        // 转换为ProjectListDTO并添加成员信息
        Page<ProjectListDTO> resultPage = new Page<>(page, size);
        ...
        resultPage.setRecords(projectListDTOs);
        return resultPage;
    }
