...
public class ProjectServiceImpl extends ServiceImpl<ProjectMapper, Project> implements ProjectService {
    ...
    @Override
    public PageInfo<ProjectListDTO> getProjectListWithMembers(Integer page, Integer size, String status, String keyword) {
        // 先获取基础项目分页数据
        PageInfo<Project> projectPage = getProjectList(page, size, status, keyword);
