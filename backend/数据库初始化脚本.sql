...
-- 插入员工数据
INSERT INTO `employee_info` (`employee_no`, `real_name`, `phone`, `email`, `department`, `position`, `role`, `status`, `entry_date`) VALUES
('EMP001', '张经理', '13800138000', 'zhangsan@example.com', '技术部', '技术经理', 'MANAGER', 1, '2020-01-01'),
('EMP002', '李主管', '13800138001', 'lizhuguan@example.com', '技术部', '技术主管', 'MANAGER', 1, '2020-02-01'),
('EMP003', '王专员', '13800138002', 'wangzhuanyuan@example.com', '技术部', '开发工程师', 'EMPLOYEE', 1, '2020-03-01'),
('EMP004', '赵助理', '13800138003', 'zhaozhuli@example.com', '产品部', '产品助理', 'EMPLOYEE', 1, '2020-04-01'),
('EMP005', '陈顾问', '13800138004', 'chenguwen@example.com', '业务部', '业务顾问', 'EMPLOYEE', 1, '2020-05-01'),
('EMP006', '刘设计师', '13800138005', 'liushejishi@example.com', '设计部', 'UI设计师', 'EMPLOYEE', 1, '2020-06-01'),
('EMP007', '孙测试', '13800138006', 'sunceshi@example.com', '技术部', '测试工程师', 'EMPLOYEE', 1, '2020-07-01'),
('EMP008', '周运维', '13800138007', 'zhouyunwei@example.com', '技术部', '运维工程师', 'EMPLOYEE', 1, '2020-08-01'),
('EMP009', '吴产品', '13800138008', 'wuchanpin@example.com', '产品部', '产品经理', 'MANAGER', 1, '2020-09-01'),
('EMP010', '郑销售', '13800138009', 'zhengxiaoshou@example.com', '销售部', '销售经理', 'MANAGER', 1, '2020-10-01');
